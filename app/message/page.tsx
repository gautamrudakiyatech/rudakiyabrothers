...
export default function DropUsaMessagePage() {
  return (
    <main className="bg-[#fafafa] min-h-[70vh] py-24 flex flex-col justify-center animate-fade-in-up">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-50 font-inter text-gray-600 leading-relaxed text-base md:text-lg">
          <p className="mb-6">
            Welcome to the <strong className="text-rudakiya-dark font-semibold">Drop Us a Message</strong> page. This section is currently being updated to provide you with the most accurate and elegant experience.
          </p>
          <p className="mb-8">
          ...
          {['contact', 'schedule', 'message', 'support'].includes('message') && (
