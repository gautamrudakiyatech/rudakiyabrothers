  ...
  return (
    <main className="bg-white min-h-screen pt-32 pb-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <p className="font-inter text-gray-500 max-w-2xl mx-auto">
          {currentCategory?.description ||
            `Explore our stunning collection of ${title.toLowerCase()}, crafted with precision and passion.`}
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length === 0 ? (
          <div className="py-24 text-center">
            <h3 className="font-playfair text-2xl text-gray-400 mb-8">
              Our {title} collection is being curated. Check back soon.
            </h3>
